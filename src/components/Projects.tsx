...
const Projects = () => {
  ...
  const featuredProjects = [
    {
      title: "Legal Assistant Application",
      period: "sept 2025 – oct 2025",
      type: "Solo Project",
      description:
        "A comprehensive legal assistant platform providing AI-powered legal consultation, lawyer booking, subscription management, and payment processing with Razorpay.",
      tech: [
        "TypeScript",
        "React",
        "Vite",
      ...
      github: "https://github.com/navneetpathak1/legal_assistant",
      live: "#",
      icon: FaCode,
    ...
    },
    {
      ...
      type: "Solo Project",
      description:
        "Built a real-time collaborative whiteboard with drawing, writing, and sharing features. Features include real-time collaboration, drawing tools, text editing, and seamless sharing capabilities.",
      tech: [
        "TypeScript",
        "Next.js",
        "Express.js",
    ...
    },
    {
      ...
      type: "Solo Project",
      description:
        "Designed a full-stack payment gateway module with transaction security, rollback, and webhook handling. Includes comprehensive security measures, transaction monitoring, and automated rollback mechanisms.",
      tech: [
        "Node.js",
        "Next.js",
        "Express.js",
    ...
    },
    {
      ...
      type: "Solo Project",
      description:
        "Created a movie streaming + GPT-powered recommendation platform. Integrated multiple APIs for seamless movie discovery and AI-powered personalized recommendations with multilingual support.",
      tech: [
        "Firebase Auth",
        "Redux Toolkit",
        "TMDB API",
  ...
  const additionalProjects = [
    {
      ...
      type: "Full Stack",
      description:
        "A MERN-stack app for creating and sharing curated content collections from YouTube and Twitter. Features secure authentication, content organization, and shareable public links.",
      tech: [
        "React",
        "TypeScript",
        "Node.js",
    ...
    },
    {
      ...
      type: "Frontend",
      description:
        "A modern food-ordering SPA inspired by Swiggy, built with clean architecture and full test coverage. Features restaurant listing, real-time search, and Redux state management.",
      tech: [
        "React",
        "Redux Toolkit",
        "React Router",
    ...
    },
    {
      ...
      description:
        "A custom-built programming language with a fully working compiler in C++ using LLVM. Features full compiler pipeline from lexical analysis to native code generation.",
      tech: [
        "C++17",
        "LLVM",
        "CMake",
    ...
    },
    {
      ...
      type: "Real-time App",
      description:
        "A sleek real-time chat application with modern design and built-in money transfer features. Features glassmorphism UI, WebSocket communication, and secure authentication.",
      tech: [
        "React",
        "Node.js",
        "Express.js",
  ...
  return (
    <section
      id="projects"
      className={`section-padding transition-colors duration-500 ${
        theme === "dark"
    ...
    >
      <div className="container-custom">
        ...
        >
          ...
          >
            Showcasing my passion for building scalable systems and innovative
            solutions
          </motion.p>
        </motion.div>
            ...
            >
              <div className="lg:w-1/2 p-8 lg:p-12">
                <div className="flex items-center space-x-4 mb-6">
                  <div
                    className={`p-3 rounded-2xl bg-gradient-to-r ${project.gradient} text-white`}
                  >
              ...
              <div className="lg:w-1/2 relative">
                <div
                  className={`h-full bg-gradient-to-br ${project.gradient} opacity-90 flex items-center justify-center`}
                >
